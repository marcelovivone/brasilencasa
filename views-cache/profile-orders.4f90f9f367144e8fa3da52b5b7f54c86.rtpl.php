				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo utf8encode($value1["dsaddress"]); ?>, <?php echo htmlspecialchars( $value1["dsnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["dszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br/><?php echo htmlspecialchars( $value1["dscity"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <?php echo htmlspecialchars( $value1["dscountry"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
