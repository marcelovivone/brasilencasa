...
class SubCategory extends Model
{
	...
	public function listAll()
	{
		...
		return $sql->select("SELECT * 
							   FROM tb_categories c, 
							   		tb_subcategories s, 
							   		tb_categories_translate ct 
							   		tb_subcategories_translate st 
							  WHERE c.idcategory = s.idcategory AND 
							  		c.idcategory = ct.idcategory AND 
							  		s.idcategory = st.idcategory AND 
							  		s.idsubcategory = st.idsubcategory AND 
							  		sc.cdlanguage = UPPER(:cdlanguage) AND 
							  		st.cdlanguage = UPPER(:cdlanguage) 
	...
	public function listByCategory($idCategory, $order = "t.nrorderappearance ASC")
	{

		$sql = new Sql();

		return $sql->select("SELECT * 
							   FROM tb_subcategories s, 
							   		tb_subcategories_translate t 
							  WHERE s.idcategory = t.idcategory AND 
							  		s.idsubcategory = t.idsubcategory AND 
