...
-->								
										<a class="nav-link" href="javascript:void(0);" id="cart" onclick="submitForm(this, <?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>);"><i class="fa fa-shopping-cart cart"></i></a>
