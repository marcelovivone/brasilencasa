					...
					<table class="table ">
						...
						<tbody>
							...
							<tr>
								...
								<td class="number">
									<?php echo htmlspecialchars( $value1["nrquantidade"], ENT_COMPAT, 'UTF-8', FALSE ); ?>

								</td>
								<td class="number">
									<?php echo formatEU($value1["vlprice"] * $value1["nrquantidade"]); ?> €
								</td>
							</tr>
							<?php } ?>
						...
						<tfoot>
							<tr>
								<th>Total before Shipping & Handling</th>
								<td></td>
								<td class="number"><?php echo htmlspecialchars( $cart["nrquantidadesubtotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
								<td class="number"><?php echo formatEU($cart["vlsubtotal"]); ?> €</td>
							</tr>
							<tr class="shipping">
								...
								<td></td>
								<td class="number">
									<?php echo formatEU($cart["vlfreight"]); ?> €
					...
					<div id="payment">
						<div class="form-row place-order">
							<div class="col-12 d-flex justify-content-center">
								<input type="submit" value="Print" class="btn btn-common col-8" onclick="window.print()">
							</div>
						</div>
					</div>
