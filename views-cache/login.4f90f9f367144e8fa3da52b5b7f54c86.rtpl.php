		...
		<div class="container">
			<div class="row">
							...
							<div class="form-group col-12">
								<div class="d-flex">
									...
									<div class="col-6 pr-0 d-flex justify-content-end">
										<a class="nav-link active p-0" href='<?php echo substring($route,0,3); ?>/forgot' role="button" aria-haspopup="true" aria-expanded="false">Forgot Your Password?</a>
									</div>
								</div>
							</div>
				...
				<div class="newuser col-6">
					<form action="/en/login" method="post" class="login-form" id="new-user-form">
						<div class="section-header">
							<h2>New Customer</h2>
						</div>
						...
						<div class="col-12 d-flex justify-content-center">
							<button type="button" class="btn btn-common col-12" onclick="validateForm(this.form, true, 'new-email', '', 'en', true)">Register</button>
						</div>
					</form>
				</div>
			</div>
