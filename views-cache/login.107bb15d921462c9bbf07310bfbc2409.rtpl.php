<?php if(!class_exists('Rain\Tpl')){exit;}?><section id="contact" class="wow fadeInUp">
	<div class="form">
		<div class="container d-flex">
			<div class="row">
				...
				<div class="registereduser col-6">
					<form action="/en/login" method="post" id="reg-user-form">
							...
							<div class="form-group col-12">
								<div class="d-flex">
									...
									<div class="col-6 pr-0 d-flex justify-content-end">
										<a class="nav-link active p-0" href='<?php echo substring($route,0,3); ?>' role="button" aria-haspopup="true" aria-expanded="false">Forgot Password</a>
									</div>
								</div>
							</div>
